...
public class Multithreading {
    ...
    public void OneThread(){
        ...
        formula(arr);
        long aTime = System.currentTimeMillis() - start;
        System.out.println("Время " + aTime);
    }
    ...
    public void  TwoThread(){
        ...
        new Thread(){
            public void run(){
                float[] b = formula(arr2);
                System.arraycopy(b, 0, arr2, 0, arr2.length);
            }
        };
        ...
        long bTime = System.currentTimeMillis() - start2;
        System.out.println("Время " + bTime);

    }
    public static void main(String[] args) {

        Multithreading start = new Multithreading();
        Multithreading start2 = new Multithreading();
        start.OneThread();
        start2.TwoThread();
    }
}
